...
import '../../../../../widgets/add_filter_widget.dart';
...
import '../../delivery_location/screens/choose_delivery_location_screen.dart';
import '../../home/widgets/recipe_item_widget.dart';
import '../../restaurant_page/screens/restaurant_page_screen.dart';
import '../../restaurants_and_dishes/restaurants_and_dishes_screen.dart';
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  InkWell(
                    onTap: () {
                      Get.to(()=>const ChooseDeliveryLocationScreen());
                    },
                    child: Row(
                      children: [
                        const Icon(
                            ...
                            child: Column(
                              children: [
                                RecipeItemWidget(
                                  ...
                                  onClick: () {
                                    Get.to(()=>const RestaurantsAndDishesScreen());
                                  },
                                ),
                                const SizedBox(
                                  height: 15,
